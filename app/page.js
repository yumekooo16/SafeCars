      ...
      <section className="mt-20 w-full h-screen overflow-hidden bg-black">
        ...
        <div className="relative z-10 h-full flex items-center px-6 md:px-12 lg:px-20 pt-20">
          <div className="max-w-4xl space-y-8">
            ...
            {/* Stats */}
            <div className="mb-5 grid grid-cols-2 gap-8 pt-16 border-t border-white/30">
        ...
        {/* Scroll indicator */}
        <div className="mb-5 absolute bottom-10 left-1/2 -translate-x-1/2 z-20 animate-bounce">
